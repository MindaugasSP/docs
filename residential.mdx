...
>
> <Steps>
>   <Step title="Set number of endpoints">
>     You can set the **number** of generated endpoints.
>   </Step>
>   <Step title="Set display per page">
>     As well as how many of them you would like to display **per page** (`10`, `25`, `50`, or `100`).
>   </Step>
>   <Step title="Hide password">
>     Hide your password by clicking on the **eye** icon. This will not affect the copy & paste function.
>   </Step>
>   <Step title="Switch view">
