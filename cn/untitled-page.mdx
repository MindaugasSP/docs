...
网页抓取 API Amazon 畅销榜目标

`amazon_bestsellers` 目标用于获取 Amazon 畅销榜页面。

> 📘 有用链接
>
> * 此目标适用于 [**Web API 高级版计划**](https://dashboard.decodo.com/register?page=scrapers/pricing?plan=907766)。
> * 此模板支持[**实时**](https://help.decodo.com/docs/web-scraping-api-real-time-requests)和[**异步**](https://help.decodo.com/docs/web-scraping-api-asynchronous-requests)集成方法。
> * 还支持[**批量**](https://help.decodo.com/docs/web-scraping-api-asynchronous-requests#queue-multiple-tasks)请求。
...
<Table align={["left","left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        浏览节点 ID 或搜索查询。多词查询必须用连字符分隔，使用"-"代替空格。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        `html` 值启用 JavaScript 渲染。[**了解更多。**](https://help.decodo.com/docs/web-scraping-api-javascript-rendering)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        设置提交查询时使用的配送位置。[**了解更多。**](tps://help.decodo.com/docs/web-scraping-api-amazon-locale#https://help.decodo.com/docs/web-scraping-api-amazon-locale#)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        指定顶级域名。[**了解更多。**](https://help.decodo.com/docs/web-scraping-api-amazon-locale)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        设置该值以更改您的 Amazon 网页界面语言。[**了解更多。**](https://help.decodo.com/docs/domain-localization#/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        设置货币。[**了解更多**](https://help.decodo.com/docs/web-scraping-api-amazon-currency)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        指定设备类型和浏览器。[**了解更多。**](https://help.decodo.com/docs/device-types#/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        设置为 `true` 以检索 XHR 和 fetch 请求列表。[**了解更多。**](https://help.decodo.com/docs/fetch-and-xhr#/)\
        默认值为 `false`。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        设置为 `true` 以接收 Markdown 响应。[**了解更多。**](https://help.decodo.com/docs/scraper-api-markdown#/)\
        默认值为 `false`。
      </td>
    </tr>
  </tbody>
...
curl --request 'POST' \
        ...
        --header 'Authorization: Basic TOKEN VALUE' \ // 使用您的授权令牌更新
...
| 结果键 | 描述                                                     |
| :---------- | :-------------------------------------------------------------- |
| `url`       | Amazon 畅销榜页面的 URL。                              |
| `page`      | 页码。                                                |\n| `pages`     | 页数。                                             |
| `query`     | 请求中使用的查询。                                      |
| `results`   | 包含详细信息的搜索结果字典。 |

<Accordion title="响应示例" icon="fa-info-circle">
  ```json
  {
      "results": {
