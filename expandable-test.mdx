...
```shellscript
curl -U 'USERNAME:PASSWORD' -x gate.curl -U 'USERNAME:PASSWORD' -x gate.decodo.com:7000 https://ip.decodo.com/decodo.com:7000 https://ip.decodo.com/
```
...
<Steps>
  <Step iconType="thin" stepNumber={2} title="value between 1 and 1440 by using the sessionduration parameter.">
    value between **1** and **1440** by [using](www.decodo.com) the `sessionduration` parameter.
  </Step>
</Steps>